...
const Navigation = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 transition-all duration-300 bg-white backdrop-blur-sm border-b border-gray-200 shadow-lg">
      <div className="w-full mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          {/* Logo/Brand */}
          <div className="flex-shrink-0">
            <div className="flex items-center">
              <img src="/logo/rod.png" alt="Rod Power Logo" className="w-12 h-12" />
              <span className="text-2xl font-black ml-2 text-gray-700">ROD</span>
              <span className="text-2xl font-black ml-1 text-gray-700">POWER</span>
            </div>
          </div>
      ...
      <div className={`${isMenuOpen ? 'block' : 'hidden'} md:hidden`}>
        <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 border-t transition-colors duration-300 bg-white border-gray-200">
          <a 
            href="/" 
            className="text-red-600 hover:text-red-700 block px-3 py-2 text-base font-bold uppercase tracking-wide transition-colors duration-300"
          ...
          <a 
            href="/bio" 
            className="text-gray-900 hover:text-red-600 block px-3 py-2 text-base font-bold uppercase tracking-wide transition-colors duration-300"
            onClick={handleMenuItemClick}
            tabIndex="0"
            aria-label="Biography"
          >
