...
import { volunteerService, doADeedService, newsletterService } from '../../lib/firebaseServices';
...
const AdminPage = () => {
  ...
  const loadData = async () => {
    ...
    try {
      const [volunteersResult, deedsResult, newslettersResult] = await Promise.all([
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          ...
          <div className="bg-gradient-to-br from-purple-600 to-purple-700 rounded-lg p-4 text-white">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-purple-100 text-xs font-medium">Newsletter</p>
                <p className="text-xl font-black">{newsletters.length}</p>
              </div>
              <svg className="w-5 h-5 text-white/70" fill="currentColor" viewBox="0 0 20 20">
          ...
          <div className="bg-gradient-to-br from-green-600 to-green-700 rounded-lg p-4 text-white">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xl font-black">{volunteers.length + deeds.length + newsletters.length}</p>
              </div>
              <svg className="w-5 h-5 text-white/70" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div className="p-4">
              {newsletters.length === 0 ? (
                <div className="text-center py-8">
                  ...
                  <p className="text-white/70 text-sm">No newsletter subscriptions yet</p>
                </div>
              ) : (
                <div className="space-y-1">
                  {newsletters.map((newsletter, index) => (
                    <div key={newsletter.id} className="bg-slate-700/30 hover:bg-slate-700/50 p-3 rounded-lg flex items-center justify-between transition-colors duration-200">
                      <div className="flex items-center space-x-3 flex-1 min-w-0">
